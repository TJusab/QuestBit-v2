...
/**
 * Fetch all the friendships that a user has
 */
 ...
 */
async function sendFriendshipInvite(userID_invites, userID_invited) {
  try {
 ...
 * Create an friendship with the status InvitationSent from userID_invites to userID_invited
 */
async function acceptFriendshipInvite(friendshipID) {
  try {
